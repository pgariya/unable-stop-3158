...
import {Form, Navigate, NavLink, useNavigate, useParams} from "react-router-dom"
...
const SingleDomestic = () => {
 ...
 let {formdata,setformdata}= value
// console.log(value)
...
<NavLink to={`/mindfulPage/${params.id}/payment`}>
<Button color='white' fontSize='18px' bg="blue" borderRadius='10px' border='none' p={15} >Next <ArrowForwardIcon></ArrowForwardIcon></Button>
</NavLink>
